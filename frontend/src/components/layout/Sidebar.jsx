...
export default function Sidebar() {
    ...
    const NAV = useMemo(() => {
        const items = [
            ...
            { icon: Building2, label: "Facilities", path: "/resources", roles: ['ADMIN', 'TECHNICIAN'] },
            { icon: CalendarDays, label: "My Bookings", path: "/bookings", roles: ['USER', 'ADMIN', 'TECHNICIAN'] },
            { icon: Plus, label: "Book Resource", path: "/bookings/new", accent: true, roles: ['USER'] },
            ...
            { icon: Plus, label: "New Ticket", path: "/tickets/new", accent: true, roles: ['USER'] },
