...
public class UserService {
    ...
    /**
     * Switch role for demo purposes — allows any user to change their own role.
     * This is for assignment demo/testing without real OAuth.
     */
    public UserResponse switchRole(String email, Role role) {
        User user = getOrCreateUser(email);
        user.setRole(role);
